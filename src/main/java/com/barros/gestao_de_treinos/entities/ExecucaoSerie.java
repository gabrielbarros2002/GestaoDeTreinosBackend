...
@Entity
@Table(name = "execucao_series")
public class ExecucaoSerie implements Serializable {
    ...
    @JoinColumn(name = "treino_exercicio_id", foreignKey = @ForeignKey(name = "fk_exercicioserie_treinoexercicio"))
    ...
    public ExecucaoSerie(Long id, TreinoExercicio treinoExercicio, Integer numSerie, Integer repeticoes, BigDecimal carga) {
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        ExecucaoSerie that = (ExecucaoSerie) o;
