...
public class ExercicioSerie implements Serializable {
    ...
    public ExercicioSerie(Long id, TreinoExercicio treinoExercicio, Integer numSerie, Integer repeticoes, BigDecimal carga) {
        this.id = id;
